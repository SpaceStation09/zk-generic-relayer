...
contract Deploy is Script {
    ...
    function run() external {
        ...
        console.log("Init Owner: %s", vm.toString(initialOwner));
        ...
        //Deploy Wallet
        {
            wallet = new Wallet(address(verifier), address(dkim), address(emailAuthImpl));
            console.log("Wallet deployed at: %s", address(wallet));
        }
        vm.stopBroadcast();
    }
}
